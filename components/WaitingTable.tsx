 ...
 * Propriedades para o componente WaitingTable.
 */
interface WaitingTableProps {
 ...
 * Um componente que exibe a fila de espera em um layout de colunas,
 * ideal para dashboards de TV onde a informação é dividida em seções visuais.
 *
 * @param {WaitingTableProps} props - As propriedades para renderizar a tabela de espera.
 * @returns A tabela da fila de espera renderizada.
 */
