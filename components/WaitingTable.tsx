                ...
                <>
                  {column.contacts.map((contact, index) => {
                    ...
                    return (
                      <div
                        key={contact.id}
                        className={`relative p-3 border-l-2 transition-all hover:bg-zinc-800 shrink-0 group ${isSlaBreached
                        ...
                        <div className="flex flex-col gap-2">
                          ...
                          <div className="flex items-end justify-between pt-2 border-t border-zinc-800/50 mt-1">
                            ...
                            <div className="flex flex-col items-end">
                              ...
                              <div className={`text-lg font-mono font-bold leading-none tracking-tight ${isSlaBreached ? 'text-red-500 animate-pulse' : 'text-zinc-300'
                                }`}>
