...
const PcActiveTeamDashboard: React.FC<PcActiveTeamDashboardProps> = ({ columns, attendants, onContactClick }) => {
    ...
    return (
        <div className="h-full overflow-hidden p-4 flex flex-col">
            {columns.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-zinc-600 gap-4 border-2 border-dashed border-zinc-800 rounded-lg m-4">
                    ...
                    <span className="text-lg font-bold uppercase tracking-widest">Nenhum atendimento ativo</span>
                </div>
            ) : (
