...
const PcDepartmentStatusDashboard: React.FC<PcDepartmentStatusDashboardProps> = ({ activeContacts, departmentMap, attendants }) => {
...
export default PcDepartmentStatusDashboard;
